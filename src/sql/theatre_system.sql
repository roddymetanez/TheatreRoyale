...
CREATE TABLE Performance 		(perfID INT, primary key, SID VARCHAR(3), perf_date DATETIME, seats_circle INT, seats_stall INT); 
...
-- test
INSERT INTO Performance (perfID, SID, perf_date, seats_circle, seats_stall)  VALUES (99999-999, 999, '2025-01-01 23:59:59', 80, 120); 
...
-- test
INSERT INTO Show_details (SID, show_ticketPrice, show_performer, show_title, show_description, show_genre, primary_language, show_live_music, show_duration, show_runlength)  VALUES (999, 1, "Test", "Test", "Klaatu Barada Nikto", "Test", "Klingon", 0, 9, 999);
